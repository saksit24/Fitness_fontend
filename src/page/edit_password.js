        ...
        return (
            <div>
                ...
                <div onSubmit={this.handleSubmit}>
                    <div >
                        <MDBInput label="รหัสผ่านเก่า" icon="lock-open"  id="password" type="password" onChange={this.handleChange} />
                        {/* <input
                            style={{ color: '#f4511e' }}
                    ...
                    <div>
                        <MDBInput label="รหัสผ่านใหม่" icon="key"  type="password" id="new_password" onChange={this.handleChange} />
                        {/* <input
                            style={{ color: '#f4511e' }}
                    ...
                    <div>
                        <MDBInput label="ยืนยันรหัสผ่าน" icon="unlock"  type="password" id="c_new_password" onChange={this.handleChange} />
                        {/* <input
                            style={{ color: '#f4511e' }}
